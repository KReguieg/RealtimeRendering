...
Cube::Cube()
{
    ...
    std::vector<QVector2D> texcoords = {
        // front
        QVector2D{ -0.5, -0.5 } ,  // A: index 0
        QVector2D{  0.5, -0.5 } ,  // B: index 1
        QVector2D{  0.5,  0.5 } ,  // C: index 2
        QVector2D{ -0.5,  0.5 } ,  // D: index 3

        // back
        QVector2D{ 0.5, -0.5 } ,  // E: index 4
        QVector2D{-0.5, -0.5 } ,  // F: index 5
        QVector2D{-0.5,  0.5 } ,  // G: index 6
        QVector2D{ 0.5,  0.5 } ,  // H: index 7

        // left
        QVector2D{ 0.5, -0.5 } ,  // A': index 8
        QVector2D{ 0.5,  0.5 } ,  // D': index 9
        QVector2D{-0.5,  0.5 } ,  // H': index 10
        QVector2D{-0.5, -0.5 } ,  // E': index 11

        // right
        QVector2D{-0.5, -0.5 } ,  // B': index 12
        QVector2D{ 0.5, -0.5 } ,  // F': index 13
        QVector2D{ 0.5,  0.5 } ,  // G': index 14
        QVector2D{-0.5,  0.5 } ,  // C': index 15

        // top
        QVector2D{-0.5,  0.5} ,  // D'': index 16
        QVector2D{ 0.5,  0.5} ,  // C'': index 17
        QVector2D{ 0.5, -0.5} ,  // G'': index 18
        QVector2D{-0.5, -0.5} ,  // H'': index 19

        // bottom
        QVector2D{ 0.5,  0.5 },  // A'': index 20
        QVector2D{ 0.5, -0.5 },  // E'': index 21
        QVector2D{-0.5, -0.5 },  // F'': index 22
        QVector2D{-0.5,  0.5 }   // B'': index 23
    };
    ...
    position_ = make_unique<VertexBuffer<QVector3D>>(vertices);
    ...
    bbox_ = BoundingBox(QVector<QVector3D>() << vertices[4] << vertices[2]);
